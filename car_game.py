...
# set window title
pygame.display.set_caption("Anelia's car game")
...
# load player vehicle
car = pygame.image.load("my_car_resized.png")
# resize image
...
# load enemy vehicle
car2 = pygame.image.load("enemy_car_resized.png")
car2_loc = car2.get_rect()
car2_loc.center = left_lane, height * 0.2

# Background music
mixer.music.load("digital-love-127441.wav")
mixer.music.play(-1)
